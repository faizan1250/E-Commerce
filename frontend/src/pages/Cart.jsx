          ...
          cartData.map((item) => {
            ...
            return (
              <div
                ...
                className="py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.4fr] items-center gap-4"
              >
                ...
                <img src={assets.bin_icon} onClick={()=>updatequantity(item._id,item.size,0)} className='w-4 mr-4 sm:w-5' alt="" srcset="" />
              </div>
            );
          })
        )}
